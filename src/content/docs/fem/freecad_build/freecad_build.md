...
<p>找不到 <code>ft5.dll</code>, <code>Qt6Widgets.dll</code>, <code>Qt6Gui.dll</code>, <code>Qt6Core.dll</code></p>
</aside>
...
<aside class="admonition admonition-info">
<p>This application failed to start because no Qt platform plugir could be initialized. Reinstalling the application may fix this problem.</p>
</aside>
...
编译后报错
<aside class="admonition admonition-info">
<p>During initialization the error "No module named 'freecad'" occurred</p>
</aside>
